...
public class UsuarioController {
	...
	public String listar(@RequestParam(name="page", defaultValue = "0") int page,Model model) {			
		...
		if(usuarioService.totalUsuarios()>=5) {model.addAttribute("tamano","mostrar");}else{model.addAttribute("tamano","no mostrar");};
	...
	public String guardar(Usuario usuario,Authentication authentication){	
