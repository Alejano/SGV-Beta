...
public interface IViajeDao extends PagingAndSortingRepository<Viaje, Long> {	
	...
	@Query("select count(v) from Viaje v inner join Vehiculo l on v.vehiculo.id_vehiculo = l.id_vehiculo where l.id_vehiculo = ?1")
